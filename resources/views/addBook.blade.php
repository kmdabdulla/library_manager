    ...
    <div class="card-body register-card-body">
      ...
      <form action="addBookToLibrary" method="post">
        ...
        <div class="input-group date" id="publishdate" data-target-input="nearest">
            <input type="text" name="published_at" class="form-control datetimepicker-input" placeholder="select publication date" data-target="#publishdate"/>
      ...
      <a href="/" class="text-center">I need to borrow/return book!</a>
    </div>
  </div>
</div>
</div>
